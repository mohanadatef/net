...
namespace KhadimiEssa.Data.Migrations
{
    ...
    [Migration("20220620075458_CountOrderForTimeToStation")]
    partial class CountOrderForTimeToStation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KhadimiEssa.Data.TableDb.AvailableTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KhadimiEssa.Data.TableDb.Note", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KhadimiEssa.Data.TableDb.OilStation", b =>
                {
                    ...
                    b.Property<int>("CountOrderForTime")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KhadimiEssa.Data.TableDb.Package", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KhadimiEssa.Data.TableDb.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KhadimiEssa.Data.TableDb.Setting", b =>
                {
                    ...
                    b.Property<bool>("IsShowDepositPrice")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("KhadimiEssa.Data.TableDb.Orders", b =>
                {
                    ...
                    b.HasOne("KhadimiEssa.Data.TableDb.Copon", "Copon")
                        .WithMany("Orders")
                        .HasForeignKey("CoponId");

                    b.HasOne("KhadimiEssa.Data.TableDb.AvailableTime", "Availabletime")
                        .WithMany("Orders")
                        .HasForeignKey("ExecutionTime")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KhadimiEssa.Data.TableDb.Package", "Package")
                        .WithMany("Orders")
